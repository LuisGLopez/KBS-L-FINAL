	...
	protected void setup() { 
  	...
  	if (args != null && args.length > 0) {
  		...
  		for (int i = 0; i < args.length; ++i) {
			...
			// send the facts formatted as CLIPS facts
			double toChose = Math.random();
			if(toChose < 0.3)
				msg.setContent("(assert (smartphone (brandPhone \"Samsung\") (modelPhone \"Galaxy S8\") (colorPhone \"Black\") (pricePhone \"1000\")))"); 
			else if(toChose < 0.6)
				msg.setContent("(assert (computer (brandPC \"Apple\") (modelPC \"Macbook Pro\") (colorPC \"Silver\") (pricePC \"2000\")))"); 
			else
				msg.setContent("(assert (creditCard (cardIdCredit \"123456789\") (maxLimitCredit \"5000\") (companyCredit \"Mastercard\")))");
